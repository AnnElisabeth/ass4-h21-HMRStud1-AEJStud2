...
ii. befolkningen totalt
henting av nye data fra tabell 07459 for å finne totalen for hele befolkningen
...
```{r}
pm2 <- pm2 %>% 
   select(knr, aar, pm2, Menn_ya_p, Kvinner_ya_p, Total_ya_p)
```
...
\#Inntektsdesiler
henter inne nye data fra tabell 12558
```{r}
...
Disse stemmer ikke. mangler knavn
